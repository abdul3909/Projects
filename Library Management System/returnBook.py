...
def returnBook():
    ...
    headingLabel = Label(headingFrame1, text="Return Book", bg='NavajoWhite3', fg='black', font=('Courier', 15))
    ...
    # Submit Button
    SubmitBtn = Button(root, text="Return", bg='antique white', fg='black', command=returnn)
